        ...
        <div class="flex-1 bg-white shadow-lg md:ml-5">
            ...
            <form action=""  enctype="multipart/form-data">
                ...
                @endphp
                 ...
                 <img class="w-20" src="{{asset('images/user/'.auth()->user()->photopath)}}">

                 <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"name="photopath" value="{{ auth()->user()->photopath }}" id="grid-last-name"type="file" placeholder="">
                 @error('photopath')
                ...
                <label for="name" class=" block text-gray-600 text-sm uppercase">Phone Number</label>
                 ...
                 <a href="{{route('userprofile.edit',auth()->user()->id)}}" class="bg-red-600 text-white px-4 py-2 mx-2 rounded-lg" >Edit Profile</a>
